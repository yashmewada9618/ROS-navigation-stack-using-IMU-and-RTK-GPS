...
class bag_file_reader:
    ...
    def scatter_plot(self,x,y,dataset,xlabel,ylabel,label,title):
        ...
        plt.legend(labels=['mov open'])
        filename = 'plot-' + str(title) +'.png'
        plt.savefig(filename)

    def read_plot_utm(self,i):
        data = pd.read_csv(self.my_topic,usecols = ['UTM_easting','UTM_northing','fix_quality'])
        if data['fix_quality'] == 4 or data['fix_quality'] == 5:
            ...
            x,y,dataset,xlabel,ylabel,label,title= data['Scaled_Easting'],data['Scaled_Northing'],data,'Easting (M)','Northing (M)','UTM_East/North','experi ' + str(i)
...
if __name__ == '__main__':
    ...
    bag_file_path1 = '/home/yash/Desktop/my_lab2/EECE5554/LAB1/stat_occ.bag'
    bag_file_path2 = '/home/yash/Desktop/my_lab2/EECE5554/LAB1/stat_open_10_min.bag'
    bag_file_path3 = '/home/yash/Desktop/my_lab2/EECE5554/LAB1/walking_occ.bag'
    bag_file_path4 = '/home/yash/Desktop/my_lab2/EECE5554/LAB1/walking_open.bag'
    ...
    known_open_stat = [42.3382053,-71.0864232]
    known_stat_occ = [42.3380100,-71.0858429]
    # stat_open.read_ltlg(known_open_stat)
    # print(stat_open.cal_RMSE(known_stat_occ))
    # print(mov_open.utm_line_fit("mov_open"))
    print(mov_occ.utm_line_fit("mov_occ"))
    # stat_open.read_plot_utm("stat_open")
    # stat.read_plot_utm("stat_occ")
    # mov_open.read_plot_utm("mov_open")
    # stat_open.read_alt(" stat_open")
    # stat.read_alt(" stat_occ")
